function lft_out = generateFiniteHorizonLft(lft_in, final_time)
%% GENERATEFINITEHORIZONLFT function which creates a time-varying LFT such
%  that IQC analysis on the resulting LFT will provide an l2-to-l2
%  norm of the input LFT till the given "final_time" index
%
%  lft_out = generateFiniteHorizonLft(lft_in, final_time)
%
%  Variables:
%  ---------
%     Input:
...
%                                a mapping from disturbances to the performance till the final_time
%
%  See also Ulft
...
%%  CHANGELOG
% Aug. 11, 2022: Sourav Sinha (srvsinha@vt.edu)